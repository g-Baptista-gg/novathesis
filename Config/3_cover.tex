...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,m){Jorge Machado, Principal Investigator, NOVA University Lisbon}
\ntaddperson{adviser}(a,m){Mauro Guerra, Auxiliary Professor, NOVA University Lisbon}
% Co-advisers(s)
