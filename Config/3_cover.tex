...
\nttitle(main,en){X-ray ressonant Raman scattering}%
\nttitle(main,pt){Um Título de Tese Longo\\e com uma Mudança de Linha Forçada}%

%         You may use "\\" to force line breaks
\nttitle(sub,en){Spectra simulation from first principles\\for Copper bellow ionization threshold\\using high-performance computing}%
...
%\ntspecialization*(en){Atomic Physics}
...
%-------------------------------------------------------------------
\ntauthorname(m){Gonçalo Garcês Sobreira Rodrigues Baptista}{Gonçalo Baptista}

%-------------------------------------------------------------------
% AUTHOR previous degree
% SYNTAX: \ntauthordegree{degree}
%-------------------------------------------------------------------
\ntauthordegree(en){BSc in Physics Engineering}
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,m){Jorge Felizardo Machado, Principal Investigator, NOVA University Lisbon}
\ntaddperson{adviser}(a,m){Mauro António Guerra, Auxiliary Professor, NOVA University Lisbon}
% Co-advisers(s)
